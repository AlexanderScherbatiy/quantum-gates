...
class IndexedTensorQuantumOperationTest {
    ...
    fun convertQubitToState() {
        ...
        assertEquals(1, zeroQubit.coefficients[0].indices.size)
        assertEquals(0, zeroQubit.coefficients[0].indices[0])
        ...
        assertEquals(1, oneQubit.coefficients[0].indices.size)
        assertEquals(1, oneQubit.coefficients[0].indices[0])
    ...
    fun convertArrayStateToState() {
        ...
        assertEquals(1, state1.coefficients[0].indices.size)
        assertEquals(0, state1.coefficients[0].indices[0])
        ...
        assertEquals(1, state10.coefficients[0].indices.size)
        assertEquals(0, state10.coefficients[0].indices[0])
        ...
        assertEquals(1, state01.coefficients[0].indices.size)
        assertEquals(1, state01.coefficients[0].indices[0])
